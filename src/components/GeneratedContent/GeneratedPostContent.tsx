...
import { isSetUserGenerationsAtom, userPostGenerationsAtom } from '../../state/atoms/userGenerations'
...
export const GeneratedPostContent: FunctionComponent = () => {
  ...
  const [fullText, setFullText] = useState<string | ''>('Every day im shuffeling and you know it')
  ...
  return (
    <div className="d-flex">
      {!!userGeneration ? (
        ...
        <div className=" w-100">
          <img className="" src={contentPlaceholder} alt="" width={150} />
